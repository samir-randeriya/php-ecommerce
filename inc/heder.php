...
<div class="navsection templete">
	...
	<li><a <?php if($currentPage =='index' ) { echo 'id="active"';} ?>href="index.php">Home</a></li>
		<?php 
				...
				?>
				 ...
				 ?>
				  <a href="page.php?pageid=<?php echo $result['id'];?>"><?php echo $result['name'];?></a> </li>
				 
				 <?php }}?>				 
		<li><a <?php if($currentPage =='contact' ) { echo 'id="active"';} ?> href="contact.php">Contact</a></li>
		
		<a <?php if(!isset($_SESSION['login'])){ if($currentPage =='request' ) { echo 'id="active"';} ?> href="request.php"><li>Request for registration<?php } ?></i></a></li>
	...
	if(!isset($_SESSION['login']))
	{
		echo '<li><a onclick=document.getElementById("id01").style.display="block" href="admin/index.php">Login</a></li>';
	}
	else{
		echo "<li><a  href=admin/index.php>Dashboard</a></li>";
                echo "<li><a href='request.php'>Request for Registration</a></li>";
		echo "<li><a href='admin/index.php?action=logout'>Logout</a></li>";
